...
class S3MP3Cache:
    ...
    def __init__(self,
                 ...
                 # Audio TTL must not exceed api_ttl_minutes: /plane/N serves cached
                 # audio before consulting flight data, so longer-lived audio would
                 # outlive the flight snapshot it describes (DOJP-27)
                 ttl_minutes: int = 3,
