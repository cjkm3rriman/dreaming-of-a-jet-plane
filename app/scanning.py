"""
Scanning endpoint for streaming MP3 file from S3
"""
...
async def stream_scanning(request: Request):
    """Stream scanning MP3 file from S3 with proper headers for browser playback"""
