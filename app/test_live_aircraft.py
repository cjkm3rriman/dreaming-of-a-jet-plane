...
def register_test_live_aircraft_routes(
    app: FastAPI,
    *,
    get_user_location_fn: Callable[[Request, Optional[float], Optional[float], Optional[str]], Awaitable[Tuple[float, float, str, str, str, str, bool]]],
    ...
    async def test_live_aircraft_endpoint(
        ...
        user_lat, user_lng, country_code, user_city, _, _, _ = await get_user_location_fn(request, lat, lng, country)
